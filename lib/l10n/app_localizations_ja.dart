...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get connectionSelfHosted => 'セルフホスト';

  @override
  String get cloudApiKeyInfo =>
      'Rybbit Cloud には Standard または Pro プランの APIキー が必要です。設定 → アカウント → APIキー で作成し、下に貼り付けてください。';

  @override
  String get cloudCreateApiKey => 'Rybbit Cloud で APIキー を作成';
  ...
  @override
  String get screenviews => 'スクリーンビュー';

  @override
  String get screensPerSession => 'スクリーン/セッション';

  @override
  String get screens => 'スクリーン';

  @override
  String get entryScreens => '入口スクリーン';

  @override
  String get exitScreens => '出口スクリーン';

  @override
  String get deviceModel => 'デバイスモデル';

  @override
  String get appVersions => 'アプリバージョン';

  @override
  String get sdkInfo => 'デバイス情報';
  ...
  @override
  String get eventTypeScreenview => 'スクリーンビュー';
}
